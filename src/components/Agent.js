...
function Agent(props) {
  return (
    <div className={cn("p-12 bg-white border-r-2 border-gray-50 hover:transition duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-2xl")}>

      <img className={cn("rounded-full")} src={props.imageUrl} alt="" />
      <p className={cn("text-blue-600 text-center pt-4")}>{props.title}</p>
